      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-1">{watchlist.length} {watchlist.length === 1 ? 'title' : 'titles'}</p>
          </div>
        </div>
        ...
        {watchlist.length === 0 ? (
          <div className="text-center py-24">
            ...
            <Link to="/" className="inline-flex items-center gap-2 bg-[#E50914] text-white font-semibold px-6 py-3 rounded-lg hover:bg-red-700 transition-colors">
              Browse Content
            </Link>
          </div>
        ) : (
